		...
		var cart_desc = "Below are the products you\'ve added to your shopping cart.";
		...
		var cart_btn_color = "#cccccc";
		var checkout_btn_color = "#000000";
		var subtotal_text_color = "#000000";
		var minicart_count_color = "#00084b";
		var quantity_button_color = "";
		var minicart_visibility_overlay = "0";
		var minicart_visibility_addtocart = "1";
		var cart_counter_visibility = "1";
		var minicart_font_family = "Josefin Sans,sans-serif";
	...
	AtharvaMinicart.addMinicartBtn = function() { 
		x = document.querySelectorAll('form[action="/cart/add"] input[type="submit"], form[action="/cart/add"] button[type="submit"], button[type="submit"][name="add"]');
	...
	AtharvaMinicart.getAtharvaMinicart = function() { 
		$.getJSON( "/cart.js", function( data ) { 
			...
			total_price = currency+" "+(data['original_total_price']/100).toFixed(2);
		  	cart_content = cart_content + "<div class='minicart_header'><h1 class='minicart-title'>"+cart_title+"</h1><span class='minicart-desc'>"+cart_desc+"</span></div>";
